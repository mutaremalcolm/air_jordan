...
const pollutantGases = [
    {
        ...
        desc: 'A highly poisonous, colourless, odourless and tasteless gas. It is very flamable and mixes well with air, easily forming explosive mixtures.'
    },
    { 
        ab: 'no',
        name: 'Nitrogen monoxide',
        desc: 'Aka Nitric oxide. A colorless gas with the formuula NO. It is one of the principal oxides of nitrogen. Nitric oxide is a free radical: it has an unpaired electron, whis is sometimes denoted by a dot in its chemical formula ( N=o or NO).'
    },
    {
        ab: 'no2',
